...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2023 at 05:03 AM
...
(27, 'SAKIP CERIA', '2023-09-30 00:00:00', '2023-10-07 00:00:00', 33, 13, ' ', 0, 3400),
(28, 'ceria1', '2023-09-13 00:00:00', '2023-09-13 00:00:00', 60, 13, '                                                                                                                                         ', 27, 3400),
(29, 'ceria2', '2023-09-13 00:00:00', '2023-09-13 00:00:00', 0, 13, ' ', 27, 3400),
(31, 'ceria3', '2023-09-13 00:00:00', '2023-09-13 00:00:00', 20, 13, '                                                                     ', 27, 3400),
(32, 'ceria4', '2023-09-13 00:00:00', '2023-09-13 00:00:00', 50, 13, '                                                                     ', 27, 3400),
(33, 'SOSIAL YES', '2023-09-14 00:00:00', '2023-09-16 00:00:00', 0, 3, ' ', 0, 3400),
(34, 'PERKANTORAN SUKSES', '2023-09-16 00:00:00', '2023-09-16 00:00:00', 0, 12, ' ', 0, 3400),
(35, 'rapat', '2023-09-14 00:00:00', '2023-09-16 00:00:00', 0, 3, ' ', 33, 3400),
(37, 'Rpat 15', '2023-09-15 00:00:00', '2023-09-15 00:00:00', 0, 3, ' ', 33, 3400),
(38, 'Jaya', '2023-09-14 00:00:00', '2023-09-14 00:00:00', 0, 1, ' ', 0, 3400),
(39, 'rapat', '2023-09-16 00:00:00', '2023-09-16 00:00:00', 0, 12, ' ', 34, 3400);
...
(97, '1111', 'Muhammad Afnan Falieh, Otw. Str.Stat', 0, 0, 0, 1, 0, 0, 0, 0);
...
ALTER TABLE `kegiatan`
  ...
  ADD KEY `FK_KegitnBPS` (`KodeBPS`),
  ADD KEY `FK_kegiatanTimKerja` (`id_tim_kerja`);
...
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `kegiatan`
  ADD CONSTRAINT `FK_KegitnBPS` FOREIGN KEY (`KodeBPS`) REFERENCES `bps` (`kodeBPS`),
  ADD CONSTRAINT `FK_kegiatanTimKerja` FOREIGN KEY (`id_tim_kerja`) REFERENCES `tim_kerja` (`id_team`);

--
-- Constraints for table `manajemenfile`
--
ALTER TABLE `manajemenfile`
  ADD CONSTRAINT `periode` FOREIGN KEY (`id_zperiode`) REFERENCES `z_periode` (`id_zperiode`),
  ADD CONSTRAINT `team` FOREIGN KEY (`id_team`) REFERENCES `z_team` (`id_zteam`);

--
-- Constraints for table `z_anggotateam`
--
ALTER TABLE `z_anggotateam`
