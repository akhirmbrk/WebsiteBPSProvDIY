...
!(function (a) {
	...
	(b.prototype = {
			...
			if (
				...
				if (!b.toString().match(/^\s*$/)) {
					...
					if (!n || f.options.allowDuplicates) {
						...
						var s = a(".badge", f.$container).filter(function () {
		...
		removeAll: function () {
			var b = this;
			for (
				a(".badge", b.$container).remove(), a("option", b.$element).remove();
		...
		refresh: function () {
			var b = this;
			a(".badge", b.$container).each(function () {
				var c = a(this),
					d = c.data("item"),
				...
				e.$container.on(
					...
					a.proxy(function (b) {
						e.$element.attr("disabled") ||
							e.remove(a(b.target).closest(".badge").data("item"));
					}, e)
				),
