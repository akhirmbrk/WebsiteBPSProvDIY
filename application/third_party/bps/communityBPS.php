...
class CommunityBPS{
	...
	****/
	public function getisdi(){ // $nip = nip bps (example 340057260)
	...
	public function getfoto(){ // $nip = nip bps (example 340057260)
		$postdata = ""; 
		$url="https://community.bps.go.id/portal/index.php?id=2,6,".$this->nip; 
