...
class TimKerja extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('Admin/monitoring/timKerjaView');
    ...
    public function indexAjax()
    {
        ...
        $this->load->vars($data);
        $this->load->view('Admin/monitoring/timKerjaAjaxView');
    }
    ...
    public function tambahTimKerja()
    {
        ...
        if ($akses < 1) {
            ...
            redirect('Admin/Monitoring/TimKerja', 'refresh');
        }
        //-------------------
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidetopbaradmin');
        $this->load->view('Admin/monitoring/tambahTimKerjaView');
        $this->load->view('template/footer');
    }
    ...
    public function tambahAnggotaTimKerja($idTim)
    {
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidetopbaradmin');
        $this->load->view('Admin/monitoring/tambahAnggotaTimKerjaView');
    ...
    public function addTimUser()
    {
        ...
        if ($hasil['point'] == 'sukses') {
            ...
            redirect('Admin/Monitoring/TimKerja/tambahTimKerja', 'refresh');
        }
    }
    ...
    public function detailTimKerja($id, $periode)
    {
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidetopbaradmin');
        $this->load->view('Admin/monitoring/detailTimKerjaView');
        $this->load->view('template/footer');
    }
