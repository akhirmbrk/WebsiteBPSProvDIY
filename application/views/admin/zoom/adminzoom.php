											...
											<tr>
												...
												<td style="vertical-align:middle;text-align: center;">
													<nav class="nav gap-2 fs-16" style="justify-content: center;">
														...
														<a name="d_edit_bagi_pegawai" class="nav-link hover-danger cat-delete" onclick="$('#btnDelete').attr('href','<?php echo base_url('Admin/Zoom/Adminbidang/hapuszoom/' . $list['idm']); ?>')" data-provide="tooltip" data-placement="top" title="Tidak Disetujui" data-toggle="modal" data-target="#modal-sqduh"><i class="fa fa-close"></i></a>
