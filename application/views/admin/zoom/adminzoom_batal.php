										...
										if (count($list_order)) {
											foreach ($list_order as $indeks => $list) {  ?>
    											<tr>
    												...
    												<td style="vertical-align:middle;text-align: center;"><span name=" m_nama_kegiatan"><?php echo $list['namapengusul']; ?></span></td>
    												<td style="vertical-align:middle;text-align: center;"><span name="m_nama_kegiatan"><?php echo $list['tgl_pengajuan_ok']; ?></span></td>
    											</tr>
    										<?php
												$nomor++;
											}
