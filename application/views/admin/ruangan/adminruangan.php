    							...
    							<table id="mp_tabel" class="table table-hover table-bordered table-responsive" data-provide="datatables" cellspacing="0">
    								<thead>
    									<tr>
    										...
    										<th width="15%" class="fw-600" style="vertical-align:middle;text-align: center;">Diajukan Oleh
    										</th>
    										<th width="15%" class="fw-600" style="vertical-align:middle;text-align: center;">Ruangan</th>
    											...
    											<tr>
    												...
    												<td style="vertical-align:middle;text-align: center;">
    													<nav class="nav gap-2 fs-16" style="justify-content: center;">
    														...
    														<a name="d_edit_bagi_pegawai" class="nav-link hover-danger cat-info" onclick="$('#btnDelete').attr('href','<?php echo base_url('Admin/Ruangan/Adminruangan/hapusmeet/' . $list['idm']); ?>')" data-provide="tooltip" data-placement="top" title="Tidak Disetujui" data-toggle="modal" data-target="#modal-sqduh"><i class="fa fa-close"></i></a>
