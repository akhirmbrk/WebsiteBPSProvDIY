    ...
    <main>
      ...
      <header class="header header- bg-img" style="background-image: url(../assets/img/gallery/1.jpg)">
        <div class="header-info">
          <div class="left">
            <h1 class="header-title">Daftar Permintaan Rapat Daring Saya</h1>
          </div>
			 ...
			 <table id="mp_tabel" class="table table-hover table-bordered table-responsive" data-provide="datatables" cellspacing="0" >			  
				  <thead>
					<tr>
					  ...
					  <th width="15%" colspan="2" class="fw-600"  style="vertical-align:middle;" >Status</th>					  
					</tr>
				  </thead>
				  <tbody>
				  <?php 
						...
						foreach ($list_order as $indeks => $list) {  ?>  
							<tr>
							 ...
							 <?php if($list['status']==0) { ?>
								...
								<td>
									 <a name="d_edit_bagi_pegawai" class="btn btn-square btn-outline btn-xs btn-dark" href="<?php echo base_url('index.php/zoomorder/editzoom/'.$list['idm']);?>" data-provide="tooltip" data-placement="top" title="Edit"><i class="ti-pencil"></i></a>
								</td>
							  ...
							  <?php } else if($list['status']==1) {  ?>
								...
								<td>
									 <a name="d_edit_bagi_pegawai" class="btn btn-square btn-outline btn-xs btn-dark" href="<?php echo base_url('index.php/zoomorder/lookzoom/'.$list['idm']);?>" data-provide="tooltip" data-placement="top" title="Lihat Detail Rapat Daring"><i class="ti-eye"></i></a>
								</td>
