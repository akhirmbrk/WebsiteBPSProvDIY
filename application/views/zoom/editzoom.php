                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form class="" method="post"
                                    action="<?php echo base_url('zoom/zoomorder/editzoom/' . $idm); ?>">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input name="perihal" class="form-control" type="text"
                                                value="<?php echo $editzoom['perihal']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="tgl_start" class="form-control"
                                                    ...
                                                    value="<?php echo $editzoom['tgl_start_tgl']; ?>" required>
                                                ...
                                                <input type="text" name="time_start" class="form-control"
                                                    value="<?php echo $editzoom['tgl_start_time']; ?>"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="tgl_end" class="form-control"
                                                    data-provide="datepicker"
                                                    value="<?php echo $editzoom['tgl_end_tgl']; ?>" required>
                                                <span class="input-group-addon">
                                                    <i class="fa fa-calendar"></i>
                                                </span>

                                                <input type="text" name="time_end" class="form-control"
                                                    value="<?php echo $editzoom['tgl_end_time']; ?>"
                                                    data-provide="clockpicker" required>
                                                <span class="input-group-addon"><i class="ti-timer"></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="number" class="form-control" name="jumlah_peserta"
                                                value="<?php echo $editzoom['jumlah_peserta']; ?>"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="keterangan" onchange="showRuangan()" id="keterangan"
                                                class="form-control" data-provide="selectpicker">
