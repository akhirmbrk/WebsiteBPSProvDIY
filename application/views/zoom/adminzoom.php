											...
											foreach ($list_order as $indeks => $list) {  ?>
    											<tr>
    												...
    												<td>
    													...
    													<a name="d_edit_bagi_pegawai" class="btn btn-square btn-outline btn-xs btn-dark" href="<?php echo base_url('zoom/adminbidang/replyzoom/' . $list['idm']); ?>" data-provide="tooltip" data-placement="top" title="Disetujui"><i class="ti-check"></i></a>
    													&nbsp
