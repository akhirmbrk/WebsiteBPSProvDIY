				  ...
				  <?php 
						...
						foreach ($list_order as $indeks => $list) {  ?>  
							<tr>
							  ...
							  <a name="d_edit_bagi_pegawai" class="btn btn-square btn-outline btn-xs btn-dark" href="<?php echo base_url('index.php/adminbidang/lookzoom/'.$list['idm']);?>" data-provide="tooltip" data-placement="top" title="Lihat Detail"><i class="ti-eye"></i></a>
							  &nbsp 
							  
							  
							  <a name="d_edit_bagi_pegawai" class="btn btn-square btn-outline btn-xs btn-dark" href="<?php echo base_url('index.php/adminbidang/hapuszoom/'.$list['idm']);?>" data-provide="tooltip" data-placement="top" title="Tidak Disetujui"><i class="ti-trash"></i></a>
