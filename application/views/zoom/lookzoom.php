...
<main>
    ...
    <header class="header header- bg-img" style="background-image: url(<?= base_url() ?>assets/img/gallery/1.jpg)">
        <div class="header-info">
            <div class="left">
                <h1 class="header-title">Deskripsi Rapat Daring</h1>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="tgl_start" class="form-control" readonly
                                                value="<?php  echo $lookzoom['tgl_start_tgl']; ?>">
                                            ...
                                            <input type="text" name="time_start" class="form-control"
                                                value="<?php  echo $lookzoom['tgl_start_time']; ?>" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="tgl_end" class="form-control" data-provide=""
                                                value="<?php  echo $lookzoom['tgl_end_tgl']; ?>" readonly>
                                            <span class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </span>

                                            <input type="text" name="time_end" class="form-control"
                                                value="<?php  echo $lookzoom['tgl_end_time']; ?>" data-provide=""
                                                readonly>
                                            <span class="input-group-addon"><i class="ti-timer"></i></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="number" class="form-control" name="jumlah_peserta"
                                            value="<?php  echo $lookzoom['jumlah_peserta']; ?>" readonly>
                                    </div>
                                </div>
