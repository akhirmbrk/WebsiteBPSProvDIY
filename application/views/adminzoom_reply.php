	...
	<div class="card card-bordered card-hover-shadow">
		...
		<div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
				  <form class="" method="post" action="<?php echo base_url('index.php/adminbidang/replyzoom/'.$idm);?>">
					
					<div class="form-group">
                      <label>Jawaban Permintaan Rapat Daring </label> <?php echo form_error('reply', '<p class="text-danger">', '</p>'); ?>
