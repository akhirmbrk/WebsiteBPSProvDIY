<header class="header header-bg-img" style="background-image: url(../assets/img/bps/polos.png)">
                              ...
                              <div class="card">
                                <div class="card-body">
                                  <figure class="teaser teaser-steve" style="display: flex; flex-direction: row;">
                                    <img src="http://localhost:8080/zoom/assets/bps/polos.png" alt="Steve image hover effect">
                                    <figcaption>
