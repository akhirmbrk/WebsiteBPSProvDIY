				  ...
				  <?php 
						...
						foreach ($list_order as $indeks => $list) {  ?>  
							<tr>
							  ...
							  <a name="d_edit_bagi_pegawai" class="btn btn-square btn-outline btn-xs btn-dark" href="<?php echo base_url('index.php/adminbidang/replyzoom/'.$list['idm']);?>" data-provide="tooltip" data-placement="top" title="Disetujui"><i class="ti-check"></i></a>
							  &nbsp 
