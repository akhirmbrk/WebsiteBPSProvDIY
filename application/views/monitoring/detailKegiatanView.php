...
text-shadow: 1px 0px 1px #CCCCCC, 0px 1px 1px #EEEEEE, 2px 1px 1px #CCCCCC, 1px 2px 1px #EEEEEE, 3px 2px 1px #CCCCCC, 2px 3px 1px #EEEEEE, 4px 3px 1px #CCCCCC, 3px 4px 1px #EEEEEE, 5px 4px 1px #CCCCCC, 4px 5px 1px #EEEEEE, 6px 5px 1px #CCCCCC, 5px 6px 1px #EEEEEE, 7px 6px 1px #CCCCCC;">
		...
		<div class="header-action">
			...
			if (count(array_intersect($roleRequie, $_SESSION['user_role'])) > 0) { ?>
				<div class="buttons">
					<a class="btn btn-primary btn-float" href="<?= base_url('monitoring/kegiatan/editKegiatan/') . $progres_kegiatan['id_kegiatan'] . "/" . $kodeKabKota ?>" title="Update Progres Kegiatan" data-provide="tooltip"><i class="ti-pencil"></i></a>
				</div>
			<?php } ?>
	...
	<div class="container">
		...
		<div class="card shadow-1">
			...
			<div class="card-body" style="text-align: center;">
				...
				<br>
				<div data-provide="easypie" data-size="200" data-line-width="10" data-percent="<?= $progres_kegiatan['persen_progres']  ?>%" data-color="<?php if ($progres_kegiatan['persen_progres']    <= 25) {
																																								echo "#f96868";
																																							} elseif ($progres_kegiatan['persen_progres']    <= 50) {
																																								echo "#f2a654";
																																							} elseif ($progres_kegiatan['persen_progres']    <= 75) {
																																								echo "#48b0f7";
																																							} else {
																																								echo "#46be8a";
					...
					<span class="easypie-data lead" style="font-size:26px">
						<!-- <?= $progres_kegiatan['progres_' . $kodeKabKota]  ?>% -->
			...
			<br>
			<?php
			if ($progres_kegiatan['last_time_update'] == null && $progres_kegiatan['last_user_update'] == null) { ?>
