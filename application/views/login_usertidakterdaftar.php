    ...
    <div class="row no-gutters min-h-fullscreen bg-white">
      ...
      <div class="col-md-6 col-lg-5 col-xl-4 bg-img " style="background-image: url(<?php echo base_url(); ?>assets/img/bg1.jpg);">
        <div class="px-80 py-80">
          ...
          <div class="alert alert-danger alert-dismissible fade show" role="alert">  <h2 class="text-center text-danger fw-500 ">Maaf Akun Email BPS Anda Tidak Terdaftar di Sistem Kami</h2>   </div>
		
		 
          <br>
		  
		  <a class="btn btn-block btn-danger btn-label"  title="BPS SINGLE SIGN ON" href="http://webapps.bps.go.id/yogyakarta/ckponline/logout.php" ><label><i class="ti-user"></i></label>LOGOUT DARI SINGLE SIGN ON</a>
